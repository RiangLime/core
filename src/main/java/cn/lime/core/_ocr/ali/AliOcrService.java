...
public class AliOcrService implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        com.aliyun.teaopenapi.models.Config config = new com.aliyun.teaopenapi.models.Config()
                // 必填，您的 AccessKey ID
                .setAccessKeyId(aliOcrProperties.getAliOcrAccessId())

                // 必填，您的 AccessKey Secret
                .setAccessKeySecret(aliOcrProperties.getAliOcrSecretId());
        // Endpoint 请参考 https://api.aliyun.com/product/ocr-api
        config.endpoint = aliOcrProperties.getAliOcrEndPoint();
    ...
    public boolean initSuccess(){
        return StringUtils.isNotEmpty(aliOcrProperties.getAliOcrSecretId())
                && StringUtils.isNotBlank(aliOcrProperties.getAliOcrAccessId())
                && StringUtils.isNotBlank(aliOcrProperties.getAliOcrEndPoint());
    }
