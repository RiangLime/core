...
//                .withClaim("auth", JSON.toJSONString(authInfoArr))
    ...
    public String getToken(Long userId, Integer authLevel, Integer vipLevel) {
...
//                .withClaim("auth", JSON.toJSONString(authInfoArr))
    ...
    public Pair<String,String> generateToken(long userId,int role, Integer platform, String ip){
        String accessToken = getToken(userId, role, 1);
