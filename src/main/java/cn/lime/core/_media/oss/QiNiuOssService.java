package cn.lime.core._media.oss;
...
public class QiNiuOssService {
    ...
    public String generateQiNiuToken(String bucket, String key) {
        Auth auth = Auth.create(qiNiuProperties.getQiNiuOssAppId(), qiNiuProperties.getQiNiuOssSecretId());
        return auth.uploadToken(bucket, key, Long.parseLong(qiNiuProperties.getQiNiuOssTokenExpire()), new StringMap(), true);
