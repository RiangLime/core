...
create table Wx_Deliver_List
(
    delivery_id   varchar(128) null comment '公司ID',
    delivery_name varchar(128) null comment '公司名'
) comment '微信运力表' collate = utf8mb4_unicode_ci;